...
{
    public partial class SRecordElementFormatterTests
    {
        [Fact]
        public void DefaultFormatter_Uses_Default_Options_And_Formatter()
        {
            ...
            Assert.Same(SRecordDataFormatter.Default, sut.RecordFormatter);
        }
        ...
        {
            var sut = new SRecordElementFormatter(SRecordElementFormatter.Options.OnlyEmitSRecordData, SRecordDataFormatter.LowercaseHex);
            Assert.Equal(SRecordElementFormatter.Options.OnlyEmitSRecordData, sut.CurrentOptions);
            Assert.Same(SRecordDataFormatter.LowercaseHex, sut.RecordFormatter);
        }
