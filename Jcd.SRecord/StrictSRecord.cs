...
namespace Jcd.SRecord
{
    ...
    {
        private const byte MaxDataLength = 32;
        ...
        /// </remarks>
        public static readonly SRecordType S0 = new SRecordType("S0", 2, MaxDataLength);
        ...
        /// </summary>
        public static readonly ReadOnlyDictionary<string, SRecordType> TypeLookup = new ReadOnlyDictionary<string, SRecordType>( new Dictionary<string, SRecordType>
            {
                { S0.Key, S0 },
                { S1.Key, S1 },
                { S2.Key, S2 },
